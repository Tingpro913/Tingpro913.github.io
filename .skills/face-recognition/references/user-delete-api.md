...
| Endpoint | `POST https://app-duaapde1f1tt-api-ELbWz8OmewKY-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/delete` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-duaapde1f1tt-api-ELbWz8OmewKY-gateway.appmiaoda.com` |
| 计费 | 否 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-duaapde1f1tt-api-ELbWz8OmewKY-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/delete",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
