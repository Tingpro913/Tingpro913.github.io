...
| Endpoint | `POST https://app-duaapde1f1tt-api-baBwZEjb7P19-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/group/getusers` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-duaapde1f1tt-api-baBwZEjb7P19-gateway.appmiaoda.com` |
| 计费 | 否 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-duaapde1f1tt-api-baBwZEjb7P19-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/group/getusers",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
