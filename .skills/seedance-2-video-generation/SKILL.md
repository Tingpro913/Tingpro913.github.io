...
| 接口 | 方法 | Endpoint | 说明 |
|------|------|----------|------|
| 创建视频任务 | POST | `https://app-duaapde1f1tt-api-nYWN4kMJ1v7L-gateway.appmiaoda.com/doubao/v3/contents/generations/tasks` | 根据多模态素材生成视频 |
| 查询视频任务 | GET | `https://app-duaapde1f1tt-api-Q9KWPzO1Eg69-gateway.appmiaoda.com/doubao/v3/contents/generations/tasks/{task_id}` | 查询任务状态和结果 |
