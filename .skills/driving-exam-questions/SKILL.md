...
- **Endpoint**: `POST https://app-duaapde1f1tt-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-duaapde1f1tt-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {
