...
| Endpoint | `POST https://app-duaapde1f1tt-api-DLEO7Bj0lORa-gateway.appmiaoda.com/v1/t2a_v2` |
| 备用地址 | `https://api-DLEO7Bj0lORa@api-bj.minimaxi.com/v1/t2a_v2` |
| 认证方式 | platform_managed |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-duaapde1f1tt-api-DLEO7Bj0lORa-gateway.appmiaoda.com` |
| 计费 | 按次计费 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游 ---
  const upstream = await fetch("https://app-duaapde1f1tt-api-DLEO7Bj0lORa-gateway.appmiaoda.com/v1/t2a_v2", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
