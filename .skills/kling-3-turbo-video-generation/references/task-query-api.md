...
| Endpoint | `GET https://app-duaapde1f1tt-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks` |
| Auth 模式 | `platform_managed`（`traefik: true`） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| third_part_domain | `app-duaapde1f1tt-api-zYm4DV8yrj8L-gateway.appmiaoda.com` |
...
const TASKS_ENDPOINT =
  "https://app-duaapde1f1tt-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks";
...
const ENDPOINT = "https://app-duaapde1f1tt-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks";
