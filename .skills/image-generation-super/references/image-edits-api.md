...
| Endpoint | `POST https://app-duaapde1f1tt-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2`       |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "https://app-duaapde1f1tt-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2",
    {
      method: "POST",
      headers: {
