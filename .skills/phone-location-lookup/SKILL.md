...
- **Endpoint**：`POST https://app-duaapde1f1tt-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-duaapde1f1tt-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
