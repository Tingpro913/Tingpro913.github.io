...
| Endpoint | `https://app-duaapde1f1tt-api-ELbWz8Omem6Y-gateway.appmiaoda.com/rest/2.0/ocr/v1/taxi_receipt` |
| Method | `POST` |
| Content-Type | `application/x-www-form-urlencoded` |
| Auth 模式 | `platform_managed`（密钥由平台注入） |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Third-party Domain | `app-duaapde1f1tt-api-ELbWz8Omem6Y-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-duaapde1f1tt-api-ELbWz8Omem6Y-gateway.appmiaoda.com/rest/2.0/ocr/v1/taxi_receipt",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
