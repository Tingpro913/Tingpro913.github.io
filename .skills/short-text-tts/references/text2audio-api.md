...
| Endpoint | `POST https://app-duaapde1f1tt-api-e94GZ5j0ljja-gateway.appmiaoda.com/text2audio` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/x-www-form-urlencoded` |
| Third-party Domain | `app-duaapde1f1tt-api-e94GZ5j0ljja-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch("https://app-duaapde1f1tt-api-e94GZ5j0ljja-gateway.appmiaoda.com/text2audio", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded",
...
Deno.serve(async (req) => {
  ...
  return fetch("https://app-duaapde1f1tt-api-e94GZ5j0ljja-gateway.appmiaoda.com/text2audio", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded",
