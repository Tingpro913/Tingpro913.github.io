...
| Endpoint | `https://app-duaapde1f1tt-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| 网关 URL（含 API ID 前缀） | `https://app-duaapde1f1tt-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| Method | POST |
| Content-Type | application/json |
| third_part_domain | `app-duaapde1f1tt-api-Aa2PZnjEw5NL-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游 API ---
  const upstream = await fetch("https://app-duaapde1f1tt-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
