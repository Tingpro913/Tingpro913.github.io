...
- **Endpoint**: `POST https://app-duaapde1f1tt-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-duaapde1f1tt-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
